                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ $websiteLang->where('lang_key','doctor_login')->first()->custom_lang }}</h1>
                                </div>
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{ route('doctor.forget.password') }}">{{ $websiteLang->where('lang_key','forget_your_pass')->first()->custom_lang }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
