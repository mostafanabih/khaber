...
@section('admin-content')
    ...
    <div class="row mb-2" id="searchSchedule">
        <div class="col-md-3">
            <div class="form-group">
                <label for="">{{ $websiteLang->where('lang_key','from')->first()->custom_lang }} <span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="">{{ $websiteLang->where('lang_key','doctor')->first()->custom_lang }}</label>
        ...
        <div class="col-md-1 newsearch">
            <button type="button" id="searchPrescribe" class="btn btn-success">{{ $websiteLang->where('lang_key','search')->first()->custom_lang }}</button>
        </div>
    </div>
    <div id="payment-box">
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','payment_history')->first()->custom_lang }}
