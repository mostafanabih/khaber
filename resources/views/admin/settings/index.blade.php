...
@section('title')
<title>{{ $websiteLang->where('lang_key','general_setting')->first()->custom_lang }}</title>
@endsection
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','general_setting')->first()->custom_lang }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings.update',$setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','old_logo')->first()->custom_lang }}</label>
                            @if ($setting->logo)
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','logo')->first()->custom_lang }}</label>
                            <div><input type="file" name="logo" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','old_favicon')->first()->custom_lang }}</label>
                            <br>
                            @if ($setting->favicon)
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','favicon')->first()->custom_lang }}</label>
                            <div><input type="file" name="favicon" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','email_send')->first()->custom_lang }}</label>
                            <input type="email" name="email" class="form-control" value="{{ $setting->email }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','save_contact_msg')->first()->custom_lang }}</label>
                            <select name="save_contact_message" id="" class="form-control">
                                <option {{ $setting->save_contact_message==0 ? 'selected':'' }} value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_lang }}</option>
                                <option {{ $setting->save_contact_message==1 ? 'selected':'' }} value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_lang }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','patient_can_login')->first()->custom_lang }}</label>
                            <select name="patient_can_register" id="" class="form-control">
                                <option {{ $setting->patient_can_register==1 ? 'selected':'' }} value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_lang }}</option>
                                <option {{ $setting->patient_can_register==0 ? 'selected':'' }} value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_lang }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','currency_icon')->first()->custom_lang }}</label>
                            <input type="text" class="form-control" name="currency_icon" value="{{ $setting->currency_icon }}">
                        </div>
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','currency_rate')->first()->custom_lang }}</label>
                            <input type="text" class="form-control" name="currency_rate" value="{{ $setting->currency_rate }}">
                        </div>


                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','app_pre_notify')->first()->custom_lang }}</label>
                            <input type="number" class="form-control" name="prenotification_hour" value="{{ $setting->prenotification_hour }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('lang_key','timezone')->first()->custom_lang }}</label>
