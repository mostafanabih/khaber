...
@section('title')
<title>{{ $websiteLang->where('lang_key','topbar_contact')->first()->custom_lang }}</title>
@endsection
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','topbar_contact')->first()->custom_lang }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.contact-us.update',$contact->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="youtube">{{ $websiteLang->where('lang_key','youtube')->first()->custom_lang }}</label>
