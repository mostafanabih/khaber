        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner-text">
                    <h1>{{ $websiteLang->where('lang_key','meeting_history')->first()->custom_lang }}</h1>
                    <ul>
                        <li><a href="{{ url('/') }}">{{ $navigation->home }}</a></li>
                        <li><span style="color:#fff !important;">{{ $websiteLang->where('lang_key','meeting_history')->first()->custom_lang }}</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="detail-dashboard">
                    <h2 class="d-headline">{{ $websiteLang->where('lang_key','meeting_history')->first()->custom_lang }}</h2>
