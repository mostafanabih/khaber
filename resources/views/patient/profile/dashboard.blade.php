                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="dash-item db-blue flex mb_30">
                                ...
                                <h4>{{ $websiteLang->where('lang_key','total_order')->first()->custom_lang }}</h4>
                                <h2>{{ $orders->count() }}</h2>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="dash-item db-red flex mb_30">
                                ...
                                <h4>{{ $websiteLang->where('lang_key','pending_app')->first()->custom_lang }}</h4>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="dash-item db-blue flex mb_30">
                                ...
                                <h4>{{ $websiteLang->where('lang_key','total_app')->first()->custom_lang }}</h4>
