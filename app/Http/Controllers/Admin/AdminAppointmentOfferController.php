...
class AdminAppointmentOfferController extends Controller
{
    ...
    public function allAppointment(){
        $appointments=AppointmentWithOffer::orderBy('id','desc')->get();
        $websiteLang=ManageText::all();
        return view('admin.appointment-offer.all',compact('appointments','websiteLang'));
    }
